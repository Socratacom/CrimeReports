...
<section class="section-padding">
	<div class="container">
		<div class="row no-gutters horizontal-card">
			<div class="col thumb col-sm-6 col-md-7 col-lg-8" style="background-image:url(http://placehold.it/760x428);">		
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card">
					...
					<div class="btn-wrapper">
						<a href="#" class="btn btn-primary btn-block">Regerster Camera</a>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-lg-3">
				<div class="card">
					...
					<div class="btn-wrapper">
						<a href="#" class="btn btn-primary btn-block">Submit Tip</a>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-lg-3">
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card">
					...
					<div class="btn-wrapper">
						<a href="#" class="btn btn-primary btn-block">View Data</a>
					</div>
				</div>
			</div>
		</div>
...
<script>jQuery(function(a){a(".card").matchHeight({byRow:!0})});</script>
<section class="section-padding">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
